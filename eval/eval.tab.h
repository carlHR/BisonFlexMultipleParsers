...
#ifndef YY_YY_EVAL_EVAL_TAB_H_INCLUDED
# define YY_YY_EVAL_EVAL_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef EVALDEBUG
# define EVALDEBUG 0
#endif
...
int evalparse (yyscan_t scanner);


#endif /* !YY_YY_EVAL_EVAL_TAB_H_INCLUDED  */
